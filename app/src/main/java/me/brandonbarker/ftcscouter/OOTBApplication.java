...
public class OOTBApplication extends Application {
    ...
    public static final String DIRECTORY = "ftcscouter", FILE = "data.json";
    ...
    public static MaterialDialog.Builder getDefaultDialog(Context context, String title, final MaterialDialog.SingleButtonCallback callback) {
